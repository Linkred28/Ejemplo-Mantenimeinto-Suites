...
// NUEVO: TICKETS DE URGENCIA BAJA (Para contrastar en el ordenamiento)
const LOW_URGENCY_TICKETS: Ticket[] = [
  {
    id: 'T-9001',
    roomNumber: '301',
    isOccupied: false,
    ...
    issueType: 'Roto / Dañado Físicamente',
    description: 'Pequeño rayón en la pata derecha del escritorio. Estético.',
    urgency: Urgency.LOW,
    impact: Impact.NONE,
    status: TicketStatus.OPEN,
    origin: 'STAFF',
    ...
    createdBy: Role.CLEANING,
    notes: [],
    history: [{ date: daysAgo(3), action: 'Reportado limpieza', user: Role.CLEANING }],
    priorityScore: 0,
  },
  {
    id: 'T-9002',
    ...
    maintenanceType: 'Electricista',
    issueType: 'No funciona / No enciende',
    description: 'Luz decorativa del balcón parpadea levemente al encender.',
    urgency: Urgency.LOW,
    impact: Impact.ANNOYING,
    status: TicketStatus.OPEN,
    origin: 'GUEST',
    ...
    createdBy: Role.RECEPTION,
    notes: [],
    history: [{ date: daysAgo(1), action: 'Reportado', user: Role.RECEPTION }],
    priorityScore: 0,
  },
  {
    id: 'T-9003',
    roomNumber: '104',
    isOccupied: false,
    asset: 'Accesorios de Baño',
    maintenanceType: 'General',
    issueType: 'Roto / Dañado Físicamente',
    description: 'El toallero de mano está un poco flojo, pero funcional.',
    urgency: Urgency.LOW,
    impact: Impact.ANNOYING,
    status: TicketStatus.OPEN,
    origin: 'STAFF',
    ...
    notes: [],
    history: [{ date: daysAgo(5), action: 'Detectado en ronda', user: Role.SUPERVISOR }],
    priorityScore: 0,
  },
  {
    id: 'T-9004',
    ...
    asset: 'Otros',
    maintenanceType: 'General',
    issueType: 'Sucio / Manchado',
    description: 'Mancha de café en la alfombra cerca de la entrada (antigua).',
    urgency: Urgency.LOW,
    impact: Impact.NONE,
    status: TicketStatus.OPEN,
    origin: 'STAFF',
    ...
    createdBy: Role.CLEANING,
    notes: [],
    history: [{ date: daysAgo(2), action: 'Reportado', user: Role.CLEANING }],
    priorityScore: 0,
  }
];

export const INITIAL_TICKETS: Ticket[] = [...BASE_TICKETS, ...EXTRA_URGENT_TICKETS, ...LOW_URGENCY_TICKETS];